...
def read_bacen_complaints(year: int, periodicity: str, period: int) -> pd.core.frame.DataFrame:
...
# IF Data - Olinda
def read_list_reports() -> pd.core.frame.DataFrame:
...
def read_registration_inst(limit: int = 100, filter: str = None, select: str = None) -> pd.core.frame.DataFrame:
